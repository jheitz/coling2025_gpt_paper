...
class GPTFeatureExtractor:
    ...
    def _get_prompt_templates(self, prompt_postfix=""):
        if self.version == 'v6_explainability':
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "gpt_feature_prompts/v6_explainability/system.txt"), "r") as f:
                system_template = f.read()
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "gpt_feature_prompts/v6_explainability/prompt.txt"), "r") as f:
                prompt_template = f.read()
        elif self.version == 'v6_7steps':
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "gpt_feature_prompts/v6_7steps/system.txt"), "r") as f:
                system_template = f.read()
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), f"gpt_feature_prompts/v6_7steps/prompt{prompt_postfix}.txt"), "r") as f:
                prompt_template = f.read()
        elif self.version == 'v6_7steps_10features':
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "gpt_feature_prompts/v6_7steps_10features/system.txt"), "r") as f:
                system_template = f.read()
            with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), f"gpt_feature_prompts/v6_7steps_10features/prompt{prompt_postfix}.txt"), "r") as f:
                prompt_template = f.read()
        else:
