        ...
        def cache_to_file_wrapper(class_self, *args, **kwargs):
            ...
            if os.path.exists(file_path):
                ...
                if elapsed_days <= n_days:
                    ...
                    if verbose:
                        print("Cache exists but is too old --> recalculating...")
            ...
            if use_cache:
                ...
                if verbose:
                    print(f"Getting value for {class_name}.{function_name} from disk using arguments: {args_shortened} and {kwargs_shortened}")
